...
public class Scrollable extends Node {
    ...
    public Scrollable(String name, float x, float y, float width, float height, int color, int radius, int scrollDir) {
    ...
    public static Scrollable parse(String nodeName, String[] properties) {
        ...
        return new Scrollable(nodeName, x, y, width, height, color, radius, scrollDir);
    }

    public String toString() {
        return "Scrollable{name='" + this.name + '\'' + ", x=" + this.x + ", y=" + this.y + ", width=" + this.width + ", height=" + this.height + ", color=" + this.color + ", radius=" + this.radius + ", scrollDir=" + this.scrollDir + ", isChild=" + isChild() + ", children=" + this.children + '}';
    }
}